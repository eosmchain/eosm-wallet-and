...
public class DealsOrderBean {
    ...
    /**
     * rows : [{"id":25,"order_id":0,"order_price":"1000.00 CNY","deal_quantity":"10.0000 MGP","order_maker":"mgptest11111","maker_passed":0,"maker_passed_at":"1970-01-01T00:00:00","order_taker":"mgptest11111","taker_passed":0,"taker_passed_at":"1970-01-01T00:00:00","arbiter":"","arbiter_passed":0,"arbiter_passed_at":"1970-01-01T00:00:00","closed":0,"created_at":"2021-01-14T12:22:13","closed_at":"1970-01-01T00:00:00","order_sn":"1610626937640","pay_type":0,"expiration_at":"2021-01-14T12:37:13","maker_expiration_at":"1970-01-01T00:00:00","restart_taker_num":0,"restart_maker_num":0}]
     * more : false
     * next_key :
     */
    ...
    public static class RowsBean implements Parcelable {
         ...
         * id : 25
         * order_id : 0
         * order_price : 1000.00 CNY
         * deal_quantity : 10.0000 MGP
         ...
         * closed : 0
         * created_at : 2021-01-14T12:22:13
         * closed_at : 1970-01-01T00:00:00
         * order_sn : 1610626937640
         * pay_type : 0
         * expiration_at : 2021-01-14T12:37:13
         * maker_expiration_at : 1970-01-01T00:00:00
         * restart_taker_num : 0
         * restart_maker_num : 0
         */
        ...
        private String maker_expiration_at;
        ...
        protected RowsBean(Parcel in) {
            ...
            pay_type = in.readInt();
            expiration_at = in.readString();
            maker_expiration_at = in.readString();
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeString(maker_expiration_at);
        ...
        public String getMaker_expiration_at() {
            return maker_expiration_at;
        }

        public void setMaker_expiration_at(String maker_expiration_at) {
            this.maker_expiration_at = maker_expiration_at;
        }
