...
public class UriToPathUtils {
    public String getAbsolutePath(Context context, Uri contentUri) {
        String picPath;
        if (Build.VERSION.SDK_INT >= 24) {
            picPath = getFilePathFromURI(context, contentUri);
        } else {
            picPath = getRealPathFromUri(context, contentUri);
        }
        return picPath;
    }
