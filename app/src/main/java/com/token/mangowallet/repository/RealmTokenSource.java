...
import com.token.mangowallet.repository.entity.RealmTokenInfo;
...
public class RealmTokenSource implements TokenLocalSource {
    ...
    @Override
    public Single<TokenInfo[]> fetch(NetworkInfo networkInfo, String walletAddress, Constants.WalletType walletType) {
        return Single.fromCallable(() -> {
            ...
            try {
                ...
                result[0] = new TokenInfo("", walletType + "", walletType + "", decimals, walletType);
        ...
        try {
            ...
            if (realmTokenInfo == null) {
                realm.executeTransaction(r -> {
                    ...
                    obj.setWalletType(tokenInfo.walletType.getType());
                });
            }
        } finally {
            if (realm != null) {
