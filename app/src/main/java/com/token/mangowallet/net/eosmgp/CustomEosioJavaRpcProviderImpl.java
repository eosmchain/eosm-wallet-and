...
import com.token.mangowallet.net.common.RequestApi;
...
public class CustomEosioJavaRpcProviderImpl implements IRPCProvider {
    ...
    @NotNull
    private RequestApi rpcProviderApi;
...
//     */
//    public CustomEosioJavaRpcProviderImpl(@NotNull String baseURL) throws EosioJavaRpcProviderInitializerError {
//        this(baseURL, false);
//    }
     ...
     * Construct a new RPC provider instance given the base URL to use for building requests.
     *
     * @param rpcProviderApi Base URL to use for building requests.
     * @throws EosioJavaRpcProviderInitializerError thrown if the base URL passed in is null.
     */
    public CustomEosioJavaRpcProviderImpl(@NotNull RequestApi rpcProviderApi) throws EosioJavaRpcProviderInitializerError {
...
//                .build();
        this.rpcProviderApi = rpcProviderApi;
    }
