...
public class CustomizeGoodsAddView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    private AppCompatEditText mCountET;
    ...
    private void init(Context context) {
        ...
        AppCompatTextView reduceIV = (AppCompatTextView) view.findViewById(R.id.tv_reduce);
        mCountET = (AppCompatEditText) view.findViewById(R.id.et_count);
        mCountET.addTextChangedListener(this);
        AppCompatTextView addIV = (AppCompatTextView) view.findViewById(R.id.tv_add);
    ...
    public void afterTextChanged(Editable s) {
        ...
        if (TextUtils.isEmpty(text)) {
            ...
            if (count == 0) {
//                Toast.makeText(mContext, "您输入的数量超过最小限制,请重新输入", Toast.LENGTH_SHORT).show();
                onValueChangeListene.onValueChange(0);
