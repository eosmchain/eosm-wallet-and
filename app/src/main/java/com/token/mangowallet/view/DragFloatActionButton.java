 ...
 * Desc: TODO
 */
public class DragFloatActionButton extends QMUIRadiusImageView2 {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                //控件距离底部的margin
                double bottomMargin = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,20,getResources().getDisplayMetrics());
