...
import com.token.mangowallet.view.basepopup.ItemLongClickListener;
...
public abstract class SpinerPopWindow<T> extends PopupWindow {
    ...
    private void initPopup() {
        View view = mInflater.inflate(R.layout.pop_spinner, null);
        setContentView(view);
        //设置PopupWindow宽高
...
//        contentView.setOnClickListener();
        int mRadius = QMUIDisplayHelper.dp2px(mActivity, 15);
        QMUIFrameLayout spinerLayout = (QMUIFrameLayout) view.findViewById(R.id.spinerLayout);
        spinerLayout.setRadius(mRadius, QMUILayoutHelper.HIDE_RADIUS_SIDE_TOP);
