...
public class LanguageActivity extends BaseActivity {
    ...
    public void initData() {
        BarUtils.setStatusBarColor(this, ContextCompat.getColor(this, R.color.durban_White));
    ...
    private void initGroupListView() {
        ...
        imageView0.setImageDrawable(ContextCompat.getDrawable(this, R.mipmap.pitchon_icon));

        imageView1 = getAccessoryImageView();
        imageView1.setImageDrawable(ContextCompat.getDrawable(this, R.mipmap.pitchon_icon));

        imageView2 = getAccessoryImageView();
        imageView2.setImageDrawable(ContextCompat.getDrawable(this, R.mipmap.pitchon_icon));

        imageView3 = getAccessoryImageView();
        imageView3.setImageDrawable(ContextCompat.getDrawable(this, R.mipmap.pitchon_icon));

        imageView4 = getAccessoryImageView();
        imageView4.setImageDrawable(ContextCompat.getDrawable(this, R.mipmap.pitchon_icon));

        imageView5 = getAccessoryImageView();
        imageView5.setImageDrawable(ContextCompat.getDrawable(this, R.mipmap.pitchon_icon));
...
//        traditionalChineseItem.addAccessoryCustomView(imageView5);
        ...
        QMUIGroupListView.newSection(this)
                .setLeftIconSize(QMUIDisplayHelper.dp2px(this, 12), ViewGroup.LayoutParams.WRAP_CONTENT)
//                .setTitle("")
...
//        groupListView.removeViewAt(0);
    ...
    private AppCompatImageView getAccessoryImageView() {
        AppCompatImageView resultImageView = new AppCompatImageView(this);
