...
public class MiningOrderIncomeAdapter extends BaseQuickAdapter<MiningOrderIncomeBean.DataBean.ListBean, BaseViewHolder> implements LoadMoreModule {

    public MiningOrderIncomeAdapter() {
        super(R.layout.item_miner_income);
    }

    @Override
    protected void convert(@NotNull BaseViewHolder baseViewHolder, MiningOrderIncomeBean.DataBean.ListBean incomeItem) {
...
//                    .apply(new RequestOptions().placeholder(R.mipmap.ic_placeholder).error(R.mipmap.ic_placeholder))
        ...
        String name = ObjectUtils.isEmpty(typeName) ? incomeItem.getTypeName() : typeName + "(" + orderLevelName + ")";
        int start = 0;
